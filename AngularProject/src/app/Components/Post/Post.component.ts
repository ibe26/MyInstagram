...
export class PostComponent implements OnInit {
  ...
  private _isLiked: boolean = false; //didUserLikePost(userID,postID):boolean;
  private _isLikeHovered = false;
  ...
  public get IsLikeHovered(): boolean {
    return this._isLikeHovered;
  }
  public SwitchIsLiked() {
    this._isLiked = !this.IsLiked;
    //likePost(userID,postID);
  }
  public SwitchLikeHovered(): void {
    if (this.IsLiked) {
      return;
    }

    this._isLikeHovered = !this._isLikeHovered;
